...
var bitcore = require('mfcore-lib');
...
PaymentProtocol.LEGACY_PAYMENT.MFC.REQUEST_CONTENT_TYPE = 'application/mfcoin-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.MFC.CONTENT_TYPE = 'application/mfcoin-payment';
PaymentProtocol.LEGACY_PAYMENT.MFC.ACK_CONTENT_TYPE = 'application/mfcoin-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'MFC';
  this.setObj(obj);
  return this;
};
